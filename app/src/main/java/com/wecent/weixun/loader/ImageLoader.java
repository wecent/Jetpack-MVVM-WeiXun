...
public class ImageLoader implements IImageLoaderClient {
    ...
    @Override
    public void getDrawableFromCache(Context context, String url, int defRes, IGetDrawableListener listener) {
        client.getDrawableFromCache(context, url, defRes, listener);
    }

    @Override
    public void displayAvatarImage(Context context, String url, ImageView imageView) {
        if (client != null) {
            client.displayAvatarImage(context, url, imageView);
        }
    }

    @Override
    public void displayAvatarImage(Activity activity, String url, ImageView imageView) {
        if (client != null) {
            client.displayAvatarImage(activity, url, imageView);
        }
    }

    @Override
    public void displayAvatarImage(Fragment fragment, String url, ImageView imageView) {
        if (client != null) {
            client.displayAvatarImage(fragment, url, imageView);
        }
    }

    @Override
    public void displayAvatarImage(Context context, String url, ImageView imageView, int defRes) {
        if (client != null) {
            client.displayAvatarImage(context, url, imageView, defRes);
        }
    }

    @Override
    public void displayAvatarImage(Activity activity, String url, ImageView imageView, int defRes) {
        if (client != null) {
            client.displayAvatarImage(activity, url, imageView, defRes);
        }
    }

    @Override
    public void displayAvatarImage(Fragment fragment, String url, ImageView imageView, int defRes) {
        if (client != null) {
            client.displayAvatarImage(fragment, url, imageView, defRes);
        }
    }

    @Override
    public void displayAvatarImage(Context context, String url, ImageView imageView, int placeholder, int error) {
        if (client != null) {
            client.displayAvatarImage(context, url, imageView, placeholder, error);
        }
    }

    @Override
    public void displayAvatarImage(Activity activity, String url, ImageView imageView, int placeholder, int error) {
        if (client != null) {
            client.displayAvatarImage(activity, url, imageView, placeholder, error);
        }
    }

    @Override
    public void displayAvatarImage(Fragment fragment, String url, ImageView imageView, int placeholder, int error) {
        if (client != null) {
            client.displayAvatarImage(fragment, url, imageView, placeholder, error);
        }
    }
    ...
    public void displayImage(Context context, String url, ImageView imageView, int placeholder, int error) {
        if (client != null) {
            client.displayImage(context, url, imageView, placeholder, error);
        }
    }
    ...
    public void displayImage(Context context, String url, ImageView imageView, int placeholder, int error, RequestOptions requestOptions) {
        if (client != null) {
            client.displayImage(context, url, imageView, placeholder, error, requestOptions);
        }
    }
    ...
    public void displayImage(Context context, String url, ImageView imageView, int defRes, RequestOptions requestOptions) {
        if (client != null) {
            client.displayImage(context, url, imageView, defRes, requestOptions);
        }
    }
    ...
    public void displayCircleImage(Context context, String url, ImageView imageView, int defRes, int borderWidth, int borderColor) {
        if (client != null) {
            client.displayCircleImage(context, url, imageView, defRes, borderWidth, borderColor);
        }
    }
    ...
    public void displayCircleImage(Activity activity, String url, ImageView imageView, int defRes, int borderWidth, int borderColor) {
        if (client != null) {
            client.displayCircleImage(activity, url, imageView, defRes, borderWidth, borderColor);
        }
    }
    ...
    public void displayCircleImage(Fragment fragment, String url, ImageView imageView, int defRes, int borderWidth, int borderColor) {
        if (client != null) {
            client.displayCircleImage(fragment, url, imageView, defRes, borderWidth, borderColor);
        }
    }
