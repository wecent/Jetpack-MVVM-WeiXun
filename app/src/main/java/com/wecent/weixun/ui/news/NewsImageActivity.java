...
import com.wecent.weixun.widget.MyScrollView;
...
import static com.wecent.weixun.R.id.scrollview;
 ...
 * date: 2017/9/24 .
 */
public class NewsImageActivity extends BaseActivity<ArticleReadPresenter> implements ArticleReadContract.View {
    ...
    private class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View view = LayoutInflater.from(NewsImageActivity.this).inflate(
            ...
            ImageLoaderUtil.LoadImage(NewsImageActivity.this, slidesBeanList.get(position).getImage(),
