 ...
 * date: 2017/9/19 .
 */
public class WeiXunDetailPresenter extends BasePresenter<WeiXunDetailContract.View> implements WeiXunDetailContract.Presenter {

    WeiXunApi mWeiXunApi;

    @Inject
    public WeiXunDetailPresenter(WeiXunApi mWeiXunApi) {
