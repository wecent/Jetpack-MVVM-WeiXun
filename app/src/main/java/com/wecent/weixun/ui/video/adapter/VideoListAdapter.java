...
public class VideoListAdapter extends BaseQuickAdapter<News,BaseViewHolder> {
    ...
    protected void convert(final BaseViewHolder helper, final News news) {
        ...
        ImageLoaderUtil.LoadImage(mContext, news.user_info.avatar_url, (ImageView) helper.getView(R.id.iv_avatar));//作者头像
        ...
        ImageLoaderUtil.LoadImage(mContext, news.video_detail_info.detail_video_large_image.url, videoPlayer.thumbImageView, R.color.color_c0bebe);//设置缩略图
