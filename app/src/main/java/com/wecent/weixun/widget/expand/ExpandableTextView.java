...
/**
 * desc: 一款通过测量文本宽高实现的轻量级可展开和收起TextView
 * author: wecent
 * date: 2019/11/25
 */
public class ExpandableTextView extends StructureTextView {
    ...
    private static final int TO_EXPAND_HINT_COLOR_BG_PRESSED = 0x00000000;
    private static final int TO_SHRINK_HINT_COLOR_BG_PRESSED = 0x00000000;
    ...
    private CharSequence getNewTextByConfig() {
        ...
        switch (mCurrState) {
            ...
            case STATE_EXPAND: {
                ...
                mLayout = new DynamicLayout(mOrigText, mTextPaint, mLayoutWidth, Layout.Alignment.ALIGN_NORMAL,
                        1.0f, 0.0f, false);
                mTextLineCount = mLayout.getLineCount();
    ...
    private class TouchableSpan extends ClickableSpan {
        ...
        public void updateDrawState(TextPaint paint) {
            ...
            switch (mCurrState) {
                case STATE_SHRINK:
                    paint.setColor(mToExpandHintColor);
                    paint.bgColor = mIsPressed ? mToExpandHintColorBgPressed : 0;
                    break;
                case STATE_EXPAND:
                    paint.setColor(mToShrinkHintColor);
                    paint.bgColor = mIsPressed ? mToShrinkHintColorBgPressed : 0;
                    break;
            }
